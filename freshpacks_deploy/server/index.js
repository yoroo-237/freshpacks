...
const ADMIN_PASS = process.env.ADMIN_PASSWORD || 'freshpacks2026';
  ...
  if (!fs.existsSync(DB_PATH)) {
    const seed = {
      products: [
        {
          id: '1',
          name: 'Fresh Drop Hoodie',
          category: 'Hoodies',
          desc: 'Premium heavyweight hoodie. Oversized fit, dropped shoulders. Available S–XXL.',
          price: 65,
          currency: 'USD',
          badge: 'New',
          available: true,
        ...
        },
        {
          ...
          category: 'Bottoms',
          desc: 'Relaxed fit cargo with zip pockets. Built for the street.',
          price: 80,
          currency: 'USD',
          badge: 'Hot',
          available: true,
...
app.listen(PORT, () => console.log(`✅ Fresh Packs running → http://localhost:${PORT}`));
